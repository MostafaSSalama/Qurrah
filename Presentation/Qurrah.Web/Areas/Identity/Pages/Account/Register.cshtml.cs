...

{
    public class RegisterModel : PageModel
    {
        ...
        #region Ctor
        public RegisterModel(SignInManager<ApplicationUser> signInManager, LanguageService localization, IMapper mapper
        ...
        #region Properties
        [BindProperty]
        public ParentUserRegistrationRequestDTO RegistrationRequest { get; set; }
