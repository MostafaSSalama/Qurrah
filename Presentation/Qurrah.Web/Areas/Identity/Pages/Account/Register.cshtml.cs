...

{
    public class RegisterModel : PageModel
    {
        ...
        #region Ctor
        public RegisterModel(SignInManager<ApplicationUser> signInManager, LanguageService localization
        ...
        #region Properties
        [BindProperty]
        public DTOs.ParentUserRegistrationRequest RegistrationRequest { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        var registrationResponse = JsonConvert.DeserializeObject<Integration.ServiceWrappers.DTOs.Authentication.RegistrationResponse>(Convert.ToString(response.Result));
