...

{
    public class RegisterCenter : PageModel
    {
        ...
        #region Ctor
        public RegisterCenter(SignInManager<ApplicationUser> signInManager, LanguageService localization
        ...
        #region Properties
        [BindProperty]
        public DTOs.CenterUserRegistrationRequest RegistrationRequest { get; set; }
